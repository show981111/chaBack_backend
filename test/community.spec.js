...
const testData = require('./testData/community.data.js');
                ...
                request(app)
                    ...
                    .end((err, response) => {
                        ...
                        if(postProvider.exp == 200){
                             expect(response.body).to.have.property('communityID');
